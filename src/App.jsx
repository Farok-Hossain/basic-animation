  ...
  return (
    <div className="flex flex-col gap-10 overflow-x-hidden">
      ...
      <section className="flex flex-col gap-10 mb-10" ref={containerRef}>
          ...
          <motion.p style={{translateX: paragraphOneValue}} className="text-slate-100 font-thin text-4xl w-1/2 mx-auto">This is a basic framer motion animation on how to get up and running with Framer Motion with some TailwindCSS</motion.p>
          <motion.p style={{translateX: paragraphTwoValue}} className="text-slate-100 font-thin text-4xl w-1/2 mx-auto">Have fun playing with Framer Motion. It is a ver powerful library, when used properly. Add some life to your websites.</motion.p>
      </section>
    </div>
  );
};
